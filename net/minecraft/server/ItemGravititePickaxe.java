...
public class ItemGravititePickaxe extends ItemTool implements ITextureProvider
{
    ...
    protected ItemGravititePickaxe(final int i, final EnumToolMaterial enumtoolmaterial) {
        super(i, 2, enumtoolmaterial, ItemGravititePickaxe.blocksEffectiveAgainst);
    }
    
    public boolean canHarvestBlock(final Block block) {
        for (int i = 0; i < ItemGravititePickaxe.blocksEffectiveAgainst.length; ++i) {
            if (ItemGravititePickaxe.blocksEffectiveAgainst[i].id == block.id) {
                return true;
            }
        }
        return false;
        ...
        if (movingobjectposition.type == EnumMovingObjectType.TILE) {
            ...
            if (!world.isStatic) {
                ...
                for (int n = 0; n < ItemGravititePickaxe.blocksEffectiveAgainst.length; ++n) {
                    if (id == ItemGravititePickaxe.blocksEffectiveAgainst[n].id) {
    ...
    static {
        ItemGravititePickaxe.blocksEffectiveAgainst = new Block[] { AetherBlocks.Holystone, AetherBlocks.Icestone, AetherBlocks.EnchantedGravitite, AetherBlocks.GravititeOre, AetherBlocks.ZaniteOre, AetherBlocks.AmbrosiumOre, AetherBlocks.LightDungeonStone, AetherBlocks.DungeonStone, AetherBlocks.Pillar, AetherBlocks.Aerogel, AetherBlocks.Enchanter, AetherBlocks.Incubator, AetherBlocks.ZaniteBlock, AetherBlocks.Freezer, AetherBlocks.QuicksoilGlass };
