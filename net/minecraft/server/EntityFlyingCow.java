...
public class EntityFlyingCow extends EntityAetherAnimal
{
    ...
    public EntityFlyingCow(final World world) {
        super(world);
        this.getSaddled = false;
        ((EntityLiving)this).texture = "/aether/mobs/Mob_FlyingCowBase.png";
        this.b(0.9f, 1.3f);
        this.jrem = 0;
        this.jumps = 1;
        this.ticks = 0;
    ...
    public void readEntityFromNBT(final NBTTagCompound nbttagcompound) {
        ...
        if (this.getSaddled) {
            ((EntityLiving)this).texture = "/aether/mobs/Mob_FlyingCowSaddle.png";
        }
    }
    ...
    public EntityAnimal spawnBabyAnimal(final EntityAnimal entityanimal) {
        return new EntityFlyingCow(((Entity)this).world);
    }
